...
class Scoreboard:
    ...
    def prep_boss_health(self):
        ...
        color = ()
        if self.settings.alien_boss_life > self.settings.starting_alien_boss_life // 3 * 2:
            color = self.text_full_health
        elif self.settings.alien_boss_life > self.settings.starting_alien_boss_life // 3:
